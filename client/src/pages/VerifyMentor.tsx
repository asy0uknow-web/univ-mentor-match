                ...
                <CardContent className="space-y-5">
                    ...
                    <div
                      ...
                      className={`border-2 border-dashed rounded-xl p-8 text-center transition-all ${
                        dragActive
                          ...
                          : "border-gray-200 700 700 hover:border-gray-300 hover:bg-slate-50 900"
                      }`}
                    >
                      <input
                        id="student-id"
                  ...
                  {previewUrl && (
                    <div className="space-y-2">
                      ...
                      <div className="relative rounded-xl overflow-hidden border border-gray-200 700 700">
                        <img
                          src={previewUrl}
                          alt="Preview"
                        ...
                        <button
                          ...
                          className="absolute top-2 right-2 bg-card /90 text-red-500 p-1.5 rounded-lg shadow-sm hover:bg-red-50 transition-colors"
                        >
                          <X className="h-4 w-4" />
                        </button>
                      </div>
