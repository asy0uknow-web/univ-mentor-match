      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="bg-card dark:bg-card border-b">
          <div className="max-w-7xl mx-auto px-4 py-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 dark:text-gray-300 mt-2">프로필 정보를 관리하고 활동을 추적하세요.</p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="grid grid-cols-12 gap-6">
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">{user.email}</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-6">
                      <div className="bg-blue-50 rounded-lg p-3">
                        <p className="text-xs text-gray-600 dark:text-gray-300 dark:text-gray-300">총 상담 수</p>
                        <p className="text-2xl font-bold text-blue-600">{myReviews?.length || 0}</p>
                      </div>
                      <div className="bg-yellow-50 rounded-lg p-3">
                        <p className="text-xs text-gray-600 dark:text-gray-300 dark:text-gray-300">평균 평점</p>
                    ...
                    <div className="space-y-2">
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-gray-200 text-gray-900 rounded-lg transition"
                      >
            ...
            <div className="col-span-9 space-y-6">
              {/* 그룹 1: 기본 설정 */}
              <Card className="bg-card dark:bg-card rounded-2xl p-6">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900">기본 설정</h2>
                    <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 mt-1">프로필 정보를 관리하세요</p>
                  </div>
                  {!isEditingProfile && (
                    <button
                ...
                {isEditingProfile ? (
                  <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                          ...
                          <button
                            ...
                            className={`px-4 py-2 rounded-lg font-medium transition ${
                              consultationTypes.includes(key as any)
                                ...
                                : "bg-slate-100 dark:bg-slate-800 text-gray-700 hover:bg-gray-200"
                            }`}
                          >
                            {label}
                          </button>
                    ...
                    <div className="flex gap-3 pt-4">
                      <button
                        ...
                        className="flex-1 px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-gray-200 text-gray-900 rounded-lg transition"
                      >
                        취소
                      </button>
                      <button
                  ...
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">대학교</p>
                        <p className="font-semibold text-gray-900">{profile?.university || "-"}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">전공</p>
                        <p className="font-semibold text-gray-900">{profile?.major || "-"}</p>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">학년</p>
                        <p className="font-semibold text-gray-900">{profile?.grade || "-"}</p>
                      </div>
                    <div>
                      <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">상담가능지역</p>
                      <p className="font-semibold text-gray-900">{profile?.region ? REGION_LABELS[profile.region] || profile.region : "-"}</p>
                    </div>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">자기소개</p>
                      <p className="font-semibold text-gray-900">{profile?.bio || "-"}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 mb-2">상담 유형</p>
              ...
              <Card className="bg-card dark:bg-card rounded-2xl p-6">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 mt-1">작성한 칼럼 관리</p>
                  </div>
                ...
                {myColumns && myColumns.length > 0 ? (
                  <div className="space-y-3">
                    {myColumns.slice(0, 4).map((column: any) => (
                      <Link key={column.id} href={`/columns/${column.id}`}>
                        <div className="p-3 border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-lg hover:border-green-500 hover:bg-green-50 transition cursor-pointer">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 dark:text-gray-300">작성한 칼럼이 없습니다</p>
                )}
              </Card>
                ...
                {myAnswers && myAnswers.length > 0 ? (
                  <div className="space-y-3">
                    {myAnswers.slice(0, 5).map((answer: any) => (
                      <div key={answer.id} className="p-3 border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 dark:text-gray-300">답변한 질문이 없습니다</p>
                )}
              </Card>
                ...
                {myReviews && myReviews.length > 0 ? (
                  <div className="space-y-4">
                    {myReviews.map((review: any) => (
                      <div key={review.id} className="p-4 border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 dark:text-gray-300">받은 후기가 없습니다</p>
                )}
              </Card>
              ...
              <Card className="bg-card dark:bg-card rounded-2xl p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  {profile && (
                    <span className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">{gallery?.length || 0}개 이미지</span>
                  )}
                </div>
                    ...
                    <div
                      ...
                      className={`border-2 border-dashed rounded-lg p-8 text-center transition ${
                        dragActive
                          ...
                          : "border-gray-300 bg-slate-50 dark:bg-slate-900 hover:border-gray-400"
                      }`}
                    >
                      <Upload className="w-8 h-8 mx-auto text-gray-400 mb-2" />
                      <p className="text-gray-600 dark:text-gray-300 dark:text-gray-300 mb-2">이미지를 드래그하거나 클릭하여 업로드</p>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        {gallery.map((image: any) => (
                          <div key={image.id} className="relative group">
                            ...
                            {image.caption && (
                              <p className="text-xs text-gray-600 dark:text-gray-300 dark:text-gray-300 mt-2 truncate">{image.caption}</p>
                            )}
                          </div>
                        ))}
                      </div>
                    ) : (
                      <p className="text-gray-600 dark:text-gray-300 dark:text-gray-300 text-center py-8">아직 업로드된 이미지가 없습니다</p>
                    )}
                  </div>
                ) : (
                  <p className="text-gray-600 dark:text-gray-300 dark:text-gray-300">멘토 프로필을 먼저 등록해주세요</p>
                )}
              </Card>
            </div>
          </div>
