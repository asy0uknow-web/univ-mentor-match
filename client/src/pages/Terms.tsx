      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-card  rounded-2xl shadow-sm p-8 sm:p-12">
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-3">제4조 (회원가입)</h2>
              ...
              <ul className="text-gray-600 300 300 leading-relaxed space-y-1 list-disc list-inside">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-3">제5조 (멘토 검증)</h2>
              <p className="text-gray-600 300 300 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-3">제6조 (서비스 이용)</h2>
              <p className="text-gray-600 300 300 leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-3">제7조 (상담 및 결제)</h2>
              <p className="text-gray-600 300 300 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-3">제8조 (책임의 한계)</h2>
              <p className="text-gray-600 300 300 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-3">제9조 (분쟁 해결)</h2>
              <p className="text-gray-600 300 300 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-3">제10조 (문의)</h2>
              <p className="text-gray-600 300 300 leading-relaxed">
                본 약관에 관한 문의사항은 아래 연락처로 문의하시기 바랍니다.
              </p>
              <div className="mt-3 p-4 bg-slate-50 900 rounded-lg">
                <p className="text-gray-700 font-medium">유니브매치 운영팀</p>
