          ...
          <div className="prose prose-gray max-w-none space-y-8">
                ...
                <table className="w-full border-collapse border border-gray-200 text-sm">
                  <thead>
                    <tr className="bg-gray-50">
                      <th className="border border-gray-200 px-4 py-3 text-left font-semibold text-gray-700">취소 시점</th>
                      <th className="border border-gray-200 px-4 py-3 text-left font-semibold text-gray-700">환불 비율</th>
                      <th className="border border-gray-200 px-4 py-3 text-left font-semibold text-gray-700">비고</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-gray-200 px-4 py-3 text-gray-600">상담 확정 후 24시간 이내</td>
                      <td className="border border-gray-200 px-4 py-3 text-green-600 font-semibold">100% 환불</td>
                      <td className="border border-gray-200 px-4 py-3 text-gray-500">단, 상담 예정 시간 12시간 이전에 한함</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-200 px-4 py-3 text-gray-600">상담 예정 시간 12시간 전</td>
                      <td className="border border-gray-200 px-4 py-3 text-yellow-600 font-semibold">50% 환불</td>
                      <td className="border border-gray-200 px-4 py-3 text-gray-500">-</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-200 px-4 py-3 text-gray-600">상담 예정 시간 12시간 이내</td>
                      <td className="border border-gray-200 px-4 py-3 text-red-600 font-semibold">환불 불가</td>
                      <td className="border border-gray-200 px-4 py-3 text-gray-500">멘토 귀책 사유 제외</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-200 px-4 py-3 text-gray-600">상담 시작 후</td>
                      <td className="border border-gray-200 px-4 py-3 text-red-600 font-semibold">환불 불가</td>
                      <td className="border border-gray-200 px-4 py-3 text-gray-500">멘토 귀책 사유 제외</td>
                    </tr>
                  </tbody>
            ...
            <section>
              ...
              <div className="mt-3 p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600 text-sm mt-1">이메일: support@univmatch.com</p>
