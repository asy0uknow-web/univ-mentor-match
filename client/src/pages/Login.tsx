...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream-50 to-cream-100 flex items-center justify-center p-3 sm:p-4">
      <div className="w-full max-w-md bg-card dark:bg-card rounded-lg shadow-lg p-4 sm:p-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-navy-900 mb-1 sm:mb-2">로그인</h1>
        <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 mb-4 sm:mb-6">UnivMatch에 로그인하세요</p>
        ...
        {/* 회원가입 링크 */}
        <p className="text-center text-xs sm:text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 mt-4 sm:mt-6">
          계정이 없으신가요?{" "}
          <button
