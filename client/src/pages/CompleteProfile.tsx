                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-3">
                    <button
                      ...
                      className="p-3 sm:p-4 border-2 border-gray-200 700 700 rounded-lg hover:border-primary hover:bg-primary/5 transition text-xs sm:text-sm font-medium"
                    >
                      🎓 멘토
                    </button>
                    <button
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <Select.Root value={grade} onValueChange={(value) => {
                          ...
                          <Select.Trigger className="mt-1 w-full px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm border border-gray-300 rounded-md inline-flex items-center justify-between bg-card ">
                          ...
                          <Select.Portal>
                            <Select.Content className="bg-card  border border-gray-300 rounded-md shadow-lg z-50">
                              <Select.Viewport className="p-1">
                                {grades.map((g) => (
                                  <Select.Item key={g.value} value={g.value} className="px-3 py-2 text-xs sm:text-sm cursor-pointer hover:bg-slate-100 800 rounded-md">
                      ...
                      <div>
                        ...
                        <div ref={regionDropdownRef} className="relative mt-1">
                          <button
                            ...
                            className="w-full px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm border border-gray-300 rounded-md text-left bg-card "
                          >
                            {mentorRegions.length > 0 ? `${mentorRegions.length}개 지역 선택됨` : "지역을 선택해주세요"}
                          </button>
                          {showRegionDropdown && (
                            <div className="absolute top-full left-0 right-0 mt-1 bg-card  border border-gray-300 rounded-md shadow-lg z-10 max-h-48 overflow-y-auto">
                              {regions.map((region) => (
                                <label key={region.value} className="flex items-center px-2 sm:px-3 py-1.5 sm:py-2 hover:bg-slate-50 900 text-xs sm:text-sm cursor-pointer">
                                  <input
                                    type="checkbox"
                        ...
                        <Select.Root value={menteeRegion} onValueChange={(value) => {
                          ...
                          <Select.Portal>
                            <Select.Content className="bg-card  border border-gray-300 rounded-md shadow-lg z-50">
                              <Select.Viewport className="p-1">
                                {regions.map((region) => (
                                  <Select.Item key={region.value} value={region.value} className="px-3 py-2 text-xs sm:text-sm cursor-pointer hover:bg-slate-100 800 rounded-md">
