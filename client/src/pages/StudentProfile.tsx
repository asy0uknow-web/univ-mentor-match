      ...
      <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-12">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="card-premium-lg p-6 sm:p-8 mb-6 group hover:-translate-y-1 transition-transform duration-200">
            ...
            <Link href="/mentors">
              <Button className="w-full text-sm font-semibold py-2.5 rounded-md bg-secondary hover:bg-secondary/90 text-white shadow-premium-md hover:shadow-premium-lg transition-all duration-200 flex items-center justify-center gap-2">
                멘토 목록 보기
                <ArrowRight className="w-4 h-4" />
              </Button>
            </Link>
