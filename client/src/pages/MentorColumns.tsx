  ...
  return (
    <PageLayout>
      <div 
        ...
        style={{
          backgroundImage: 'url(https://d2xsxph8kpxj0f.cloudfront.net/310519663280786037/Gy6RaYwMhnXP5TJQbTpkxJ/column-studio-background-v2-WZffAaNfpRwU3HTxyUQFim.webp)',
          ...
          <div className="mb-12">
            <div className="mb-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold mb-2 text-[var(--color-text-primary)]">🔥 인기칼럼</h2>
