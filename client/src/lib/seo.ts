...
export const PAGE_META = {
  ...
  mentorDetail: (mentorName: string, major: string) => ({
    title: `${mentorName} 멘토 프로필`,
    description: `${mentorName} 멘토와 1:1 상담으로 ${major}에 대해 알아보세요. 실제 재학생의 경험과 조언을 받을 수 있습니다.`,
    keywords: `${mentorName}, ${major}, 멘토, 상담, 대학생활`,
  }),
  bookings: {
    title: "상담 문의",
    description: "예약한 상담 내역을 확인하고 관리하세요.",
    keywords: "상담 예약, 상담 내역, 예약 관리",
  },
  messages: {
    title: "메시지",
    description: "멘토와의 메시지 대화를 확인하세요.",
    keywords: "메시지, 대화, 멘토 상담",
  },
  notifications: {
    title: "알림",
    description: "상담 예약 확정, 메시지 등 모든 알림을 확인하세요.",
    keywords: "알림, 예약 확정, 메시지 알림",
  },
  profile: {
    title: "내 프로필",
    description: "프로필을 관리하고 멘토로 등록하세요.",
    keywords: "프로필, 멘토 등록, 프로필 관리",
  },
};
