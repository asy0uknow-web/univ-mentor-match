...
export const PAGE_META: Record<string, any> = {
  home: {
    title: "실제 재학생과 함께하는 전공 탐색 플랫폼",
    description: "실제 재학생 멘토와 1:1 상담으로 생기부 컨설팅, 진로 상담, 학업 관리를 받으세요. 전공 미스매치 없는 올바른 선택을 시작하세요.",
    keywords: "유니브매치, 전공 선택, 멘토 상담, 생기부 컨설팅, 진로 상담, 대학 탐방, 학과 선택, 전공 취업, 학과 분위기, 대학생활, 학과 취업률, 전공 미스매치, 캠퍼스 생활, 대학 입시, 1:1 상담",
  },
  mentors: {
    title: "멘토 찾기",
