...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0B1120] text-slate-400" role="contentinfo" aria-label="사이트 정보">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 sm:gap-12 mb-12 sm:mb-16">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#safety-guide" className="hover:text-white transition-colors">안전 가이드</a></li>
