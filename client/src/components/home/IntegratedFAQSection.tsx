...
const FAQ_ITEMS: FAQItem[] = [
  // 비용 관련
  {
    question: "상담료는 얼마인가요?",
    answer:
      "유니브매치는 멘토가 자신의 전문성에 따라 상담료를 직접 설정하는 자율 가격제를 채택하고 있습니다. 서비스는 이용자 간의 매칭을 돕는 플랫폼으로서 별도의 중개 수수료를 받지 않습니다. 다만, 안전한 거래를 위해 반드시 서비스 내 결제 시스템을 이용해 주셔야 하며 외부 직거래는 금지됩니다. (이용약관 제7조)",
    category: "cost",
  ...
  },
  {
    ...
    answer:
      "운영진은 이용자 간의 분쟁 발생 시 중재 역할을 수행할 수 있습니다. 멘토의 부적절한 언행이나 허위 정보 제공으로 문제가 생긴 경우, 증빙 자료와 함께 support@univmatch.com으로 문의해 주시면 사실 확인 후 환불 및 이용 제한 등 단호한 조치를 취합니다. (이용약관 제8조, 환불 정책)",
    category: "safety",
    categoryLabel: "🛡️ [안전] 안심하고 이용하는 환경",
  },
